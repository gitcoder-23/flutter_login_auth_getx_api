...
import 'package:flutter_login_auth_getx/controllers/registration_controller.dart';
import 'package:flutter_login_auth_getx/screens/auth/widgets/input_fields.dart';
import 'package:flutter_login_auth_getx/screens/auth/widgets/submit_button.dart';
  ...
  Widget registerWidget() {
    return Column(
      children: [
        ...
        SubmitButton(
          onPressed: () => registerationController.registrationWithEmail(),
          title: 'Register',
        )
      ],
    );
